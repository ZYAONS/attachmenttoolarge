"use strict";
(self["webpackChunkextension"] = self["webpackChunkextension"] || []).push([[345],{
...
__webpack_require__.d(__webpack_exports__, {
  startReplayRecorder: () => (/* binding */ I),
  stopReplayRecorder: () => (/* binding */ w)
});
...
const mediaSelectorPlugin = (/* unused pure expression or super */ null && ({
...
const pseudoClassPlugin = (/* unused pure expression or super */ null && ({
...
let printed$1 = (/* unused pure expression or super */ null && ({}));
...
postcss$1$1.Root;
postcss$1$1.Node;
const tagMap = (/* unused pure expression or super */ null && ({
  script: "noscript",
...
let printed = (/* unused pure expression or super */ null && ({}));
...
var NodeType$2 = /* @__PURE__ */ (/* unused pure expression or super */ null && (((NodeType2) => {
...
const NAMESPACES = (/* unused pure expression or super */ null && ({
  svg: "http://www.w3.org/2000/svg",
  "xlink:href": "http://www.w3.org/1999/xlink",
  xmlns: "http://www.w3.org/2000/xmlns/"
}));
const SVGTagMap = (/* unused pure expression or super */ null && ({
  altglyph: "altGlyph",
  altglyphdef: "altGlyphDef",
  altglyphitem: "altGlyphItem",
  animatecolor: "animateColor",
...
var ReplayerEvents = /* @__PURE__ */ (/* unused pure expression or super */ null && (((ReplayerEvents2) => {
...
var e = (/* unused pure expression or super */ null && ({ type: "xstate.init" }));
function r(t2) {
...
const webGLVarMap = /* @__PURE__ */ (/* unused pure expression or super */ null && (new Map()));
...
const defaultMouseTailConfig = (/* unused pure expression or super */ null && ({
  duration: 500,
  lineCap: "round",
  lineWidth: 3,
  strokeStyle: "red"
...
;// ./node_modules/@openpanel/web/dist/replay-V6FXES7X.js
var replay_V6FXES7X_s=null;function I(o,f){if(typeof document>"u"||typeof window>"u")return;replay_V6FXES7X_s&&replay_V6FXES7X_s();let v=o.maxEventsPerChunk??200,i=o.flushIntervalMs??1e4,k=o.maxPayloadBytes??1048576,e=[],d=0,r=null;function l(t){if(e.length===0)return;let n=JSON.stringify(e);if(new TextEncoder().encode(n).length>k){if(e.length>1){let a=Math.floor(e.length/2),y=e.slice(0,a),R=e.slice(a),_=t&&y.some(T=>T.type===2);e=y,l(_),e=R,l(!1);return}e=[];return}let x=e[0].timestamp,S=e[e.length-1].timestamp;try{f({chunk_index:d,events_count:e.length,is_full_snapshot:t,started_at:new Date(x).toISOString(),ended_at:new Date(S).toISOString(),payload:n}),d+=1,e=[]}catch(a){throw console.error("[ReplayRecorder] sendChunk failed",a),a}}function g(t){let n=t||e.some(m=>m.type===2);e.length>=v?l(n):t&&e.length>0&&l(!0)}let c=o.maskAllText!==!1,u=o.unmaskTextSelector,b=record({emit(t,n){e.push(t),g(!!n)},checkoutEveryNms:i,maskAllInputs:o.maskAllInputs??!0,maskTextSelector:c?"*":"[data-openpanel-replay-mask]",maskTextFn:c&&u?(t,n)=>n?.closest(u)?t:t.replace(/\S/g,"*"):void 0,blockSelector:o.blockSelector??"[data-openpanel-replay-block]",blockClass:o.blockClass,ignoreSelector:o.ignoreSelector});r=setInterval(()=>{if(e.length>0){let t=e.some(n=>n.type===2);l(t)}},i);function p(){if(document.visibilityState==="hidden"&&e.length>0){let t=e.some(n=>n.type===2);l(t)}}function h(){if(e.length>0){let t=e.some(n=>n.type===2);l(t)}}document.addEventListener("visibilitychange",p),window.addEventListener("pagehide",h),replay_V6FXES7X_s=()=>{if(e.length>0){let t=e.some(n=>n.type===2);l(t)}r&&(clearInterval(r),r=null),document.removeEventListener("visibilitychange",p),window.removeEventListener("pagehide",h),b?.(),replay_V6FXES7X_s=null}}function w(){replay_V6FXES7X_s&&replay_V6FXES7X_s()}
